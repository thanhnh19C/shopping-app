...
public class CartProduct7 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.cartp7);
        ...
        btnPay1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(CartProduct7.this, AdminPayActivity.class));
            }
        });
        ...
        btnBackHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Switch to PayActivity when btnPay1 is pressed
                startActivity(new Intent(CartProduct7.this, CustomerHomeActivity.class));
            }
        });
